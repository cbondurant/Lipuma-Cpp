...
int main (int argc, char **argv){
	...
	QObject::connect(saveAction, &QAction::triggered, fileMenu,  [canvas, mainWin](){
		QString s = QFileDialog::getSaveFileName(mainWin, "Open Image", "$HOME/Documents/", "Lipuma Files (*.lpm); All Files (*)");
	...
	QObject::connect(loadAction, &QAction::triggered, mainWin,  [mainWin](){
		QString s = QFileDialog::getOpenFileName(mainWin, "Open Image", "$HOME/Documents/", "Lipuma Files (*.lpm); All Files (*)");
